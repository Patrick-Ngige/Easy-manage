...
<div style="width:100vw;height:90vh;display:flex;flex-direction:row;margin-top:-2.45rem">
    ...
    <div style="padding:1rem;width:80vw;margin-left:0rem">
        <div style="padding:1rem;">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="ms-3">
                                            <p class="mb-1"><?php echo $project->assigned_members; ?></p>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <p class="fw-normal mb-1"><?php echo $project->project_name; ?></p>
                                </td>
                                <td>
                                    <p class="fw-normal mb-1"><?php echo ($project->group_status == 0 ? 'ongoing' : 'completed'); ?></p>
                                </td>
                                <td>
                                    <form method="POST">
                                        <a href="http://localhost/easy-manage/admin-update-form/?id=<?php echo $project->group_id; ?>" style="padding:6px">
                                            <img src="http://localhost/easy-manage/wp-content/uploads/2023/06/edit.png" style="width:25px" alt="">
                                        </a> &nbsp;&nbsp;
                                        <input type="hidden" name="" value="">
                                        <a href="#" style="padding:6px;text-decoration:none;color:#315B87">
                                            <img src="http://localhost/easy-manage/wp-content/uploads/2023/06/pause-2.png" style="width:25px" alt="">
                                        </a> &nbsp;&nbsp;
                                    </form>
                                </td>
                            </tr>
            ...
            <?php } else {
                echo 'Error retrieving project IDs.';
            }
            ?>
        </div>
    </div>
