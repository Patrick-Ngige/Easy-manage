    ...
    <div style="padding:1rem;width:80vw;margin-left:0rem">
        <div style="padding:1rem;">
            ...
            if (!empty($group_projects)) {
                echo '<table class="table align-middle mb-0 bg-white table-hover" style="width:90%;margin-left:5%;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;margin-top:3%;">';
                echo '<thead class="bg-light">';
                echo '<tr style="font-size:large;color:#315B87;padding-left:2rem">';
                echo '<th>Assigned Members</th>';
                echo '<th>Project</th>';
                echo '<th>Status</th>';
                echo '<th>Actions</th>';
                echo '</tr>';
