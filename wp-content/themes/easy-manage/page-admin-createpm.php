                                        ...
                                        <form action="" method="POST" style="font-size:16px;">
                                            ...
                                            <div class="form-outline mb-3">
                                                ...
                                                <input type="text" id="form2Example27" class="form-control form-control-md"
                                                    placeholder="Enter project task" name="pm-name" value="<?php echo isset($_POST['pm-name']) ? $_POST['pm-name'] : ''; ?>" />
                                            ...
                                            <label class="form-label" for="form2Example27" style="font-weight:600;">Role:</label>
                                                ...
                                                <select class="form-select" aria-label="Default select example"
                                                    ...
                                                    <option value="Jon Doe" <?php echo isset($_POST['pm-role']) && $_POST['pm-role'] === 'Jon Doe' ? 'selected' : ''; ?>>Jon Doe</option>
                                                    <option value="Jon Doe" <?php echo isset($_POST['pm-role']) && $_POST['pm-role'] === 'Jon Doe' ? 'selected' : ''; ?>>Jon Doe</option>
                                                    <option value="Jon Doe" <?php echo isset($_POST['pm-role']) && $_POST['pm-role'] === 'Jon Doe' ? 'selected' : ''; ?>>Jon Doe</option>
                                                </select>
