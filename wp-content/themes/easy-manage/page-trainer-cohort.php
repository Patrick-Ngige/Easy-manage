...
<div style="width:100vw;height:90vh;display:flex;flex-direction:row;margin-top:-2.45rem">
    ...
    <div style="margin: auto;height: 100vh;margin-top: 6rem;">
        <div style="width: 40vw; background-color: #F7F7F7; border-radius: 10px; box-shadow: 0px 2px 6px rgba(0, 0, 0, 0.2); padding: 2rem; ">
            <h2 style="color: #315B87; margin-bottom: 1rem;">Assigned Cohort</h2>
            <div style="display: flex; justify-content: center;">
                <div style="width:35vw; background-color: #FAFAFA; border-radius: 10px; padding: 1rem; box-shadow: 0px 2px 6px rgba(0, 0, 0, 0.2);">
                    <?php if ($cohort_data) { ?>
                        <h4 style="color: #315B87; margin-bottom: 1rem; text-align: center;"><?php echo $cohort_data->cohort_info; ?></h4>
                        <p><span style="color: #315B87; font-weight: bold;">Starting Date:</span><?php echo $cohort_data->starting_date; ?></p>
                        <p><span style="color: #315B87; font-weight: bold;">Ending Date:</span><?php echo $cohort_data->ending_date ?></p>
                        <p style="margin-top: 1rem;"><?php echo $cohort_data->cohort_info; ?></p>
