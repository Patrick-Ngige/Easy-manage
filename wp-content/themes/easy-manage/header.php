...
<body>
    ...
    <div style="display:flex;margin-top:-1.99rem">
        ...
        <div class=" "
            style="width:80%;height:10vh;display: flex; justify-content: space-between; align-items: center; background-color: #FAFAFA; box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px; border-radius: 5px; padding: 0px 20px 0px 20px; ">
            <div>
                <h5>Dashboard</h5>
            </div>
