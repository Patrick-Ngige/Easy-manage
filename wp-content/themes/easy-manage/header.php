...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.0/css/bootstrap.min.css" integrity="sha512-DaRm29U0BktG8LQMdGJtHuxPHm2blX/khLH3e+dPEwyYZUfZJZT1HR0sE+ueLsRxyZK1YskfFzjcgsCwM5im3w==" crossorigin="anonymous" referrerpolicy="no-referrer" />
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js" integrity="sha512-c7xES9CZ5u+1oCG03V9NpdFTz9l6/UcxSyyHo5TWSFzX/h+Jd8kEh3OG2/ijg0f+b2Sd7nTdOahJF0kQQ4H98w==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.0/js/bootstrap.bundle.min.js" integrity="sha512-VasBw1Lm6H0bABk4ncXo9yNugdYx5kWAXbt3cq6yGOLXEOODTtYz+rQABs64S6Hkav9JopVs6yaeRGQcWmhmIg==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>

    <?php wp_head(); ?>
</head>

<body style="background-color:#E3E3EE;height:80vh;display:flex;margin-top:0rem;overflow:hidden">
