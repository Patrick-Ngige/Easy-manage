<div class="sidenav-trainee "
    ...
    <div >
        <div class="side-menu <?php echo (strpos($_SERVER['REQUEST_URI'], 'trainee-dashboard') !== false) ? 'active' : ''; ?>">
            <a href="http://localhost/easy-manage/trainee-dashboard/" style=" display: block; padding: 16px ; text-decoration: none;color:#FAFAFA "> <img
                    src='http://localhost/easy-manage/wp-content/uploads/2023/06/dashboard.png'
                    style="width:2.5rem;height:2.5rem;" /> Dashboard</a>
        </div>
        <div class="side-menu <?php echo (strpos($_SERVER['REQUEST_URI'], 'completed-projects') !== false) ? 'active' : ''; ?>">
            <a href="http://localhost/easy-manage/completed-projects/" style=" display: block; padding: 16px; text-decoration: none; color:#FAFAFA;"><img
        ...
        <div class="side-menu <?php echo (strpos($_SERVER['REQUEST_URI'], 'trainee-group-projects') !== false) ? 'active' : ''; ?>">
            <a href="http://localhost/easy-manage/trainee-group-projects/" style=" display: block; padding: 16px; text-decoration: none; color:#FAFAFA;"><img
